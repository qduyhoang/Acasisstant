 ...
 */
use ComplexityException as ComplexityException;
...
class DiffEngine {
	...
	function __construct( $tooLong = 2000000, $powLimit = 2 ) {
	...
	protected function diffInternal( array $from, array $to ) {
		...
		if ( $this->m == 0 || $this->n == 0 ) {
			...
			if ( $this->m * $this->n > $this->tooLong ) {
				...
				debug_backtrace( "Limiting max number of differences to $this->maxDifferences\n" );
			}
			/*
